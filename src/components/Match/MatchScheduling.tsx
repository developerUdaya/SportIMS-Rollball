                      ...
                      {match.result ? (
                        ...
                        <div className="flex space-x-2">
                          <input
                            ...
                            onChange={(e) => {
                              const team2Sets = parseInt((e.target.nextElementSibling as HTMLInputElement)?.value || '0');
                          ...
                          <input
                            ...
                            className="w-16 px-2 py-1 border border-gray-300 rounded text-center"
                            onChange={(e) => {
                              const team1Sets = parseInt((e.target.previousElementSibling?.previousElementSibling as HTMLInputElement)?.value || '0');
